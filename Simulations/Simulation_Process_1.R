...
head(y) # check first 6 rows of the data
...
reem_model_heavy_t<-REEMtree_heavy_mode(y ~X1+X2+X3 , data=simdat ,random=~1, groups=~id,cv=TRUE,family_h=Student(df = 5))
reem_model_heavy_t
